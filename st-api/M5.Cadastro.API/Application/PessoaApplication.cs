...
using M5.Cadastro.API.Interfaces;
using M5.Cadastro.API.Models;
using Microsoft.IdentityModel.Tokens;

namespace M5.Cadastro.API.Application
{
    /// <summary>
    ...
    public class PessoaApplication : IPessoaApplication
    {
        ...
        {
            var pessoa = new Pessoa(pessoaUpdate.Ativo, pessoaUpdate.DataNascimento, pessoaUpdate.Genero, pessoaUpdate.Nome);
